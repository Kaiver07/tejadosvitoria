...
export const site = {
  ...
  phone: '+34945123456',
  phoneDisplay: '945 12 34 56',
  email: 'info@tejadosvitoriaexpress.com',
  address: {
    street: 'Calle Portal de Castilla 22',
    postalCode: '01008',
  ...
  defaultDescription:
    'Expertos en reparación e instalación de tejados en Vitoria-Gasteiz. ☎ 945 12 34 56 · Presupuesto gratis · 18 años de experiencia · Urgencias 24h.',
  ...
  services: [
    {
      ...
      metaDescription:
        '✅ Reparación de tejados en Vitoria-Gasteiz. Presupuesto gratis ☎ 945 12 34 56. Actuamos en 24 h. 18 años de experiencia. Sin sorpresas en el precio.',
      h1: 'Reparación de Tejados en Vitoria-Gasteiz',
      content: {
        intro: [
          'El tejado es el elemento más expuesto de cualquier edificio. En Vitoria-Gasteiz, el clima continental atlántico combina precipitaciones frecuentes en otoño e invierno con heladas que agravan las grietas existentes. Tejados Vitoria Express lleva 18 años reparando tejados en toda la comarca de Álava, desde intervenciones puntuales de urgencia hasta rehabilitaciones completas de cubierta.',
          'Una reparación a tiempo evita daños mucho más costosos: una gotera no atendida puede llegar a pudrir la estructura de madera, deteriorar el aislamiento e incluso afectar al interior del inmueble. Nuestro equipo realiza una inspección gratuita con diagnóstico fotográfico antes de cualquier presupuesto, para que sepas exactamente qué se va a hacer y cuánto va a costar. No comenzamos ningún trabajo sin tu aprobación expresa.',
          'Trabajamos tanto en viviendas particulares como en comunidades de propietarios, locales comerciales y edificios históricos del casco de Vitoria. Utilizamos materiales homologados para el clima de Álava —tejas antihielo, morteros de reparación de alta resistencia, impermeabilizantes elastoméricos— y aplicamos garantía de mano de obra de 2 años en todas nuestras intervenciones.',
        ],
        whatWeDo: [
      ...
      image: { src: '/images/reparacion-tejados-vitoria-new.png', alt: 'Reparación de tejado en Vitoria-Gasteiz por especialistas', width: 1408, height: 768 },
    },
    {
      ...
      metaDescription:
        '✅ Instalación de tejados nuevos en Vitoria-Gasteiz. Teja cerámica, hormigón y pizarra. ☎ 945 12 34 56 · Presupuesto gratis · Garantía 10 años.',
      h1: 'Instalación de Tejados Nuevos en Vitoria-Gasteiz',
      content: {
        intro: [
          'Cuando un tejado ha llegado al final de su vida útil o estás construyendo de nuevo, la instalación correcta desde el origen marca la diferencia durante las próximas décadas. En Tejados Vitoria Express diseñamos e instalamos tejados nuevos a medida en Vitoria-Gasteiz y toda la comarca de Álava, con materiales de primera calidad seleccionados para resistir las condiciones climáticas del País Vasco.',
          'Un tejado nuevo bien ejecutado combina tres funciones críticas: estanqueidad total frente al agua, buen aislamiento térmico y acústico, y durabilidad estructural durante décadas. Trabajamos con teja cerámica, de hormigón y pizarra natural, y utilizamos como base láminas impermeabilizantes transpirables de alta duración que garantizan la estanqueidad incluso si alguna teja superficial se desplaza.',
      ...
      image: { src: '/images/instalacion-tejados-nuevos-vitoria.png', alt: 'Instalación de tejado nuevo en Vitoria-Gasteiz con teja cerámica', width: 1408, height: 768 },
    },
    {
      ...
      image: { src: '/images/impermeabilizacion-cubiertas-vitoria.png', alt: 'Impermeabilización de cubierta plana en Vitoria-Gasteiz', width: 1536, height: 1024 },
    },
    {
      ...
      metaDescription:
        '✅ Reparación de goteras en Vitoria-Gasteiz. Localización garantizada del origen ☎ 945 12 34 56. Urgencias 24h. Presupuesto gratis. Sin perforar paredes.',
        ...
        faqs: [
          {
            ...
            a: 'Sí. Atendemos urgencias 7 días a la semana, incluyendo fines de semana y festivos. Llama al 945 12 34 56 y enviamos técnico en el menor tiempo posible.',
          },
          {
      ...
      image: { src: '/images/reparacion-goteras-vitoria.png', alt: 'Reparación de gotera en tejado en Vitoria-Gasteiz', width: 1536, height: 1024 },
    },
    {
      ...
      content: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'En Vitoria, con presencia de arbolado en muchos barrios, recomendamos limpiar los canalones una o dos veces al año: en primavera (tras la caída de semillas) y en otoño (tras la caída de hojas). Una limpieza preventiva cuesta mucho menos que reparar los daños de un desbordamiento.',
          },
          {
      ...
      image: { src: '/images/instalacion-canalones-vitoria.png', alt: 'Instalación de canalones de aluminio en tejado en Vitoria-Gasteiz', width: 1536, height: 1024 },
    },
    {
      ...
      image: { src: '/images/retejado-vitoria-new.png', alt: 'Retejado completo de cubierta en Vitoria-Gasteiz con teja cerámica nueva', width: 1408, height: 768 },
    },
    {
      ...
      metaDescription:
        '✅ Instalación de claraboyas y ventanas Velux en Vitoria-Gasteiz. Desde 400 €. ☎ 945 12 34 56. Instalación certificada. Garantía. Presupuesto gratis.',
      h1: 'Instalación de Claraboyas y Ventanas Velux en Vitoria-Gasteiz',
      content: {
        intro: [
          'Las claraboyas y ventanas de tejado son la solución perfecta para llevar luz natural y ventilación a plantas bajo cubierta, áticos y buhardillas, espacios que de otro modo quedan oscuros y calurosos en verano. Una instalación correcta aporta luminosidad sin comprometer la estanqueidad del tejado; una instalación mal ejecutada, sin embargo, se convierte en un foco de goteras permanente.',
          'En Tejados Vitoria Express instalamos claraboyas fijas y ventanas abatibles de las principales marcas —Velux, Fakro y Roto— utilizando sus kits de impermeabilización originales, diseñados específicamente para cada modelo y tipo de cubierta. El uso de kits genéricos o flash universal es la principal causa de goteras en claraboyas; nosotros no los utilizamos nunca. Trabajamos en tejados de teja, pizarra y chapa.',
        ],
        whatWeDo: [
      ...
      image: { src: '/images/claraboyas-velux-vitoria-new.png', alt: 'Instalación de ventana Velux en tejado en Vitoria-Gasteiz', width: 1408, height: 768 },
    },
    {
      ...
      metaDescription:
        '✅ Aislamiento térmico de cubiertas en Vitoria-Gasteiz. Reduce hasta un 30% la factura de calefacción. ☎ 945 12 34 56. Presupuesto gratis. 18 años experiencia.',
      ...
      content: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Sí. Si el acceso al bajo cubierta lo permite, podemos instalar aislamiento proyectado desde el interior del desván sin necesidad de retirar ninguna teja. Es la opción más económica y menos invasiva.',
          },
        ],
      },
      relatedServices: ['instalacion-de-tejados-nuevos', 'retejado-sustitucion-de-tejas', 'impermeabilizacion-de-cubiertas'],
      image: { src: '/images/aislamiento-cubiertas-vitoria-new.png', alt: 'Aislamiento térmico de cubierta en Vitoria-Gasteiz con paneles PIR', width: 1408, height: 768 },
    },
    {
      ...
      metaDescription:
        '✅ Rehabilitación de fachadas en Vitoria-Gasteiz. Grietas, humedades, pintura. ☎ 945 12 34 56. Presupuesto gratis. Andamio incluido. 18 años de experiencia.',
      h1: 'Rehabilitación de Fachadas en Vitoria-Gasteiz',
      content: {
        intro: [
          'La fachada es la primera línea de defensa del edificio frente a la lluvia, el viento y los cambios de temperatura. En Vitoria-Gasteiz, el ciclo de heladas y deshielo en invierno es especialmente agresivo con los revestimientos exteriores: genera micro-fisuras que permiten la entrada de agua, que al congelarse ensancha las grietas y acelera el deterioro. Una fachada en mal estado no es solo un problema estético, es una vía de entrada de humedad al interior del edificio.',
          'En Tejados Vitoria Express realizamos rehabilitaciones integrales de fachada: diagnóstico del estado del revestimiento, reparación de grietas y desprendimientos, tratamiento impermeabilizante y acabado con pintura elastomérica exterior o proyectado de mortero monocapa. Trabajamos tanto en fachadas de obra vista como revocadas, y gestionamos la tramitación de las ayudas a la rehabilitación cuando el proyecto lo permite.',
        ],
        whatWeDo: [
      ...
      image: { src: '/images/rehabilitacion-fachadas-vitoria-new.png', alt: 'Rehabilitación de fachada en edificio de Vitoria-Gasteiz', width: 1408, height: 768 },
    },
    {
      ...
      metaDescription:
        '✅ Limpieza profesional de tejados en Vitoria-Gasteiz desde 8 €/m². ☎ 945 12 34 56. Eliminamos musgo, líquenes y suciedad. Presupuesto gratis. 18 años experiencia.',
      ...
      image: { src: '/images/limpieza-tejados-vitoria-new.png', alt: 'Limpieza de tejado con hidrolimpiadora en Vitoria-Gasteiz', width: 1408, height: 768 },
    },
    {
      ...
      image: { src: '/images/panel-sandwich-vitoria-new.png', alt: 'Instalación de cubierta de panel sándwich en nave en Vitoria-Gasteiz', width: 1536, height: 1024 },
    },
    {
      ...
      metaDescription:
        '✅ Cubiertas industriales y naves en Vitoria-Gasteiz y Álava. ☎ 945 12 34 56. Panel sándwich, chapa y membrana. Presupuesto gratis. 18 años de experiencia.',
      ...
      content: {
        intro: [
          ...
          'Ofrecemos soluciones integrales: desde el diagnóstico del estado actual de la cubierta hasta la ejecución completa de la nueva, incluyendo estructura, impermeabilización, aislamiento, evacuaciones, lucernarios y medidas de seguridad en cubierta (líneas de vida, escaleras de acceso). Trabajamos con panel sándwich, chapa grecada, membrana bituminosa y sistemas de cubierta invertida para grandes superficies.',
        ],
        whatWeDo: [
      ...
      image: { src: '/images/cubiertas-industriales-vitoria-new.png', alt: 'Cubierta industrial de panel sándwich en nave en Vitoria-Gasteiz', width: 1536, height: 1024 },
    },
  ] as ServiceConfig[],
