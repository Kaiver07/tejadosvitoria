...
import { site as siteCore } from './site-core';
...
// ============================================================
// DATOS DEL NEGOCIO (ver ./site-core.ts) + SERVICIOS Y ZONAS
// ============================================================
export const site = {
  ...siteCore,
  ...
  services: [
    {
      ...
      content: {
        intro: [
          'El tejado es el elemento más expuesto de cualquier edificio. En Vitoria-Gasteiz, el clima continental atlántico combina precipitaciones frecuentes en otoño e invierno con heladas que agravan las grietas existentes. Tejados Vitoria lleva 18 años reparando tejados en toda la comarca de Álava, desde intervenciones puntuales de urgencia hasta <a href="/servicio/retejado-sustitucion-de-tejas/">rehabilitaciones completas de cubierta</a>.',
    ...
    },
    {
      ...
      content: {
        intro: [
          ...
          'En Tejados Vitoria realizamos rehabilitaciones integrales de fachada: diagnóstico del estado del revestimiento, reparación de grietas y desprendimientos, tratamiento impermeabilizante y acabado con pintura elastomérica exterior o proyectado de mortero monocapa. Trabajamos tanto en fachadas de obra vista como revocadas, y en rehabilitaciones integrales aprovechamos también para mejorar el <a href="/servicio/aislamiento-de-cubiertas/">aislamiento de cubierta</a> del edificio, además de gestionar la tramitación de las ayudas a la rehabilitación cuando el proyecto lo permite.',
        ],
        whatWeDo: [
